package com.arya1021.alipay.runnables;
                ...
                for (int i = 0; i < jSONArray.length(); i++) {
                    ...
                    if ((charSequence.toString()).contains(replace)) {
                        if (hashMap.containsKey(replace)) {
                            ...
                            if (!isBankMessage) {
                                Log.d("arik","解析错误：如果是银行入账短信解析出错请联系开发人员调整");
                                return;
                            }
...
//								context.sendBroadcast(intent2);
                            ...
                            Log.d("arik",stringBuilder.toString());
                ...
                Log.d("arik","json解析异常：" + e2.getMessage());
            }
        }
    }
